...
router.get('/cars', (req, res, next) => {
	//because we want everyone to see out cars wether theyre logged in or not
	//if we wanted to protect these resourses we could add the middleware back in and place it between the route and the callback function. (second argument)
	Car.find()
		.then((cars) => {
